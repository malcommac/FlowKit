...
public extension TableSection {
	...
	struct HeaderFooterEvent<View: ReusableViewProtocol> {
	...
	struct HeaderFooterEventsSubscriber<View: ReusableViewProtocol> {

		public var dequeue: ((HeaderFooterEvent<View>) -> Void)? = nil

		public var height: ((HeaderFooterEvent<View>) -> CGFloat)? = nil
		public var estimatedHeight: ((HeaderFooterEvent<View>) -> CGFloat)? = nil

		public var willDisplay: ((HeaderFooterEvent<View>) -> Void)? = nil
		public var didDisplay: ((HeaderFooterEvent<View>) -> Void)? = nil
		public var endDisplay: ((HeaderFooterEvent<View>) -> Void)? = nil
